...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            // Используем bridge.platform.sdk — это гарантированно работает после bridge.initialize()
            function subscribeVKBridge() {
                try {
                    ...
                    if (nativeSdk && typeof nativeSdk.subscribe === 'function') {
                        ...
                        // Fallback: пробуем window.vkBridge если nativeSdk не дал subscribe
            ...
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/adf9162b4067f1ffb958fca9af1314fb.data.unityweb',
                        frameworkUrl: 'Build/d7411566e87f10096abc64e24d42e17e.framework.js.unityweb',
                        codeUrl: 'Build/6d7afe5f636249b3816e3265291b3e46.wasm.unityweb',
